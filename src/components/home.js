        ...
        return (
            <div className="w-full mt-10 px-40">
                <div className="bg-white shadow-md rounded-lg px-8 pt-8 pb-8 mb-5">
                    ...
                    <div className="mb-2 text-center justify-center  text-black text-lg font-semibold opacity-80 hover:opacity-100 duration-300"><img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" className='mx-auto mb-2 w-1/4 cursor-pointer' onClick={this.linkGithub}/>
